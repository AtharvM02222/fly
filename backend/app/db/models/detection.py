"""Detection and DetectionEvent models."""
...
class Detection(Base):
    """Detection record from edge device."""
    ...
    )  # new | confirmed | assigned | fixed | verified
...
class DetectionEvent(Base):
    """Audit trail for detection status changes and notes."""
    ...
    )  # created | merged | status_change | note_added
